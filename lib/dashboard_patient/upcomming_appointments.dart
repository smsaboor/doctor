    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          ...
          AppointmentCard(doctor: doctors[1]),
          SizedBox(
            height: 5,
          ),
          AppointmentCard(doctor: doctors[2]),
          SizedBox(
            height: 5,
          ),
          AppointmentCard(doctor: doctors[3]),
          SizedBox(
            height: 5,
          ),
          AppointmentCard(doctor: doctors[4]),
          SizedBox(
            height: 5,
          ),
          AppointmentCard(doctor: doctors[5]),
          SizedBox(
            height: 5,
          ),
