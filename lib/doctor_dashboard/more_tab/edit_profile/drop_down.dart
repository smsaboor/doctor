...
class DropDownsMulti extends StatefulWidget {
  DropDownsMulti({Key? key, this.title}) : super(key: key);
  final String? title;
  @override
  _DropDownsMultiState createState() => _DropDownsMultiState();
}

class _DropDownsMultiState extends State<DropDownsMulti> {
  ...
  final _items = _animals
      .map((animal) => MultiSelectItem<Animal>(animal, animal.name??animal.name!))
      .toList();
          ...
          child: Column(
            children: <Widget>[
              ...
              MultiSelectChipField(
                ...
                decoration: BoxDecoration(
                  border: Border.all(color: Colors.blue[700]??Colors.red, width: 1.8),
                ),
