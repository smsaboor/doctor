...
class OldAppointmentCard extends StatefulWidget {
  ...
  @override
  _OldAppointmentCardState createState() =>
      _OldAppointmentCardState();
}

class _OldAppointmentCardState extends State<OldAppointmentCard> {
  @override
